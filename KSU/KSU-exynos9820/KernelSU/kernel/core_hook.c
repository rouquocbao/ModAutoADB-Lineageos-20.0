...
/* KernelSU manual-hook mode: disable kprobe-based hooking for KernelSU only.
 * The rest of the kernel keeps CONFIG_KPROBES; these translation units use the
 * manual hooks patched into the fs and input source files instead. */
